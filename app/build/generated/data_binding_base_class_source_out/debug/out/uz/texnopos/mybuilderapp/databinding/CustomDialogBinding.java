...
public final class CustomDialogBinding implements ViewBinding {
  ...
  private CustomDialogBinding(@NonNull CardView rootView, @NonNull TextView tvProgressMsg) {
  ...
  public static CustomDialogBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tv_progress_msg;
      TextView tvProgressMsg = rootView.findViewById(id);
      if (tvProgressMsg == null) {
        break missingId;
      }

      return new CustomDialogBinding((CardView) rootView, tvProgressMsg);
    }
